...
- Task:
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled.png){:class="img-responsive"}
...
- Performance:
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 1.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 1.png){:class="img-responsive"}
...
- Other statistics of performance
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 2.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 2.png){:class="img-responsive"}
    
- Pretraining also recreates human behaviour wrt size of colour change
    
    ![Xie et al., 2022 - CNN-RNN/Untitled 3.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 3.png){:class="img-responsive"}
...
- Handicapping the end-to-end model by decreasing size or injecting noise will somewhat harm performance, but will not recreate performance curves
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 4.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 4.png){:class="img-responsive"}
...
- Pretrained model’s capacity markers were also robust to hyperparameters, but not to unnaturalistic datasets!
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 5.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 5.png){:class="img-responsive"}
...
- Performance
    ...
    - Now, rather than report a change amongst N stimuli, subject must recall colour of a chosen stimulus
        ...
        ![Xie et al., 2022 - CNN-RNN/Untitled 6.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 6.png){:class="img-responsive"}
        

- Performance
    
    ![Xie et al., 2022 - CNN-RNN/Untitled 7.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 7.png){:class="img-responsive"}
...
- To reiterate: the SD of this error distribution resembles the pretrained case only
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 8.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 8.png){:class="img-responsive"}
...
- It is not exactly normal, so one way to describe its shape is to take the residual when you minus a normal from it:
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 9.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 9.png){:class="img-responsive"}
...
- Confidence reporting
    ...
    - This was again recreated in the pretrained models
        ...
        ![Xie et al., 2022 - CNN-RNN/Untitled 10.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 10.png){:class="img-responsive"}
...
- Swap error is roughly recreated
    ...
    - This is indicated by a higher-than-chance resemblance of the reported colour to that of another stimulus
        ...
        ![Xie et al., 2022 - CNN-RNN/Untitled 11.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 11.png){:class="img-responsive"}
        

- Prioritising cue
    - From Ma et al. 2014:
        
        ![Xie et al., 2022 - CNN-RNN/Untitled 12.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 12.png){:class="img-responsive"}
    ...
    - This result is again recreated with the pretrained model
        ...
        ![Xie et al., 2022 - CNN-RNN/Untitled 13.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 13.png){:class="img-responsive"}
...
- There are similarities between overall neural activation in the pretrained CNN and fMRI data when performing the binary decision task
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 14.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 14.png){:class="img-responsive"}
    

- Decoding ability only shows human-like set-size effect in later layers of the CNN
    
    ![Xie et al., 2022 - CNN-RNN/Untitled 15.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 15.png){:class="img-responsive"}
    

- Increasing number of distractors (i.e. N-1) shrinks the neural representation of the encoded colour ring
    
    ![Xie et al., 2022 - CNN-RNN/Untitled 16.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 16.png){:class="img-responsive"}
...
- In this case, pretraining can recreate human-like capacity only in small RNN models, not in larger ones
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled 17.png](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 17.png){:class="img-responsive"}
...
- Options for all parts of the above pipeline are given in their Figure 1:
    ...
    ![Xie et al., 2022 - CNN-RNN/Untitled.jpeg](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled.jpeg){:class="img-responsive"}
...
- Xie et al. 2022: “Geometry of sequence WM in macaque PFC”
    ...
    - Model neural state space trained on task very similar to PFC two-photon imaging
        ...
        ![Xie et al., 2022 - CNN-RNN/Untitled 1.jpeg](/notes/Public/Xie et al., 2022 - CNN-RNN/Untitled 1.jpeg){:class="img-responsive"}
