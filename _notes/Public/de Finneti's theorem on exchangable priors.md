...
**Finalise**
- For any observation sequence $x$, we have: $$|\pi(X_{1:n}=x) - \pi^{\rho_m}(X_{1:n}=x)| \leq \int_0^1 \left(\exp\left\{\frac{2n^2}{m-n}\right\} -1\right)\rho_m(d\theta) = \exp\left\{\frac{2n^2}{m-n}\right\} -1 \to 0$$
